  ...
  return (
    <View className="flex-1 items-center p-4">
          ...
          header: () => (
            <SafeAreaView>
              <View className="flex-row items-center gap-2 px-4">
                ...
                <Text className="text-2xl font-semibold flex-1">Nowy zasób</Text>
              </View>
            </SafeAreaView>
          ),
        }}
      ...
      <Input
        ...
        onSubmitEditing={() => createResource()}
      />
      <Button className="w-full" onPress={() => createResource()}>
        <Text>Utwórz zasób</Text>
      </Button>
    </View>
  );
}
